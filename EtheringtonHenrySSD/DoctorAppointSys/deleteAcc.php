...
<th>Email: </th> </tr></h2>";
    ...
    while ($row = $result->fetch()) { 
	  ...
	  echo' <h1> <form action="deleteAppointment.php" method="post">
            <input type="hidden" name="patientId" value="'.$row['PatientID'].'"> 
            <input type="submit" value="yes cancel" Style="height: 50px; width: 825px" name="delete">
           </h1> 
        </form>';
     ...
     echo '</table>';         
      ...
      print "<h2> No rows matched the query. Click<a href='selectCancelAppointment.php'> here</a> to go back </h2>";
    }} 
